...
from objslampp.functions.geometry.max_voxelization_3d import \
    max_voxelization_3d
from objslampp.functions.geometry.max_voxelization_3d import MaxVoxelization3D
