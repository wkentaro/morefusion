...
class Images:
    ...
    def __init__(self):
        self._dataset = objslampp.datasets.MySyntheticRGBDPoseEstimationDataset(  # NOQA
            root_dir='/home/wkentaro/data/datasets/wkentaro/objslampp/ycb_video/synthetic_data/20190715_113906.827534'  # NOQA
        )
