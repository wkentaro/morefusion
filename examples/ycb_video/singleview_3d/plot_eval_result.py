...
df_pcd = pandas.read_csv(
    f"../singleview_pcd/logs.csv_files/data.{index:08d}.csv", index_col=0
)
df_pcd["visibility"] = np.clip(df_pcd["visibility"], 0, 1)
df_noocc = pandas.read_csv(
    f"./logs.csv_files/data.wo_occ.{index:08d}.csv", index_col=0
)
