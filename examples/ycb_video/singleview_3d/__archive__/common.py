...
class Inference:
    def __init__(self, dataset="my_synthetic", gpu=0):
        ...
        model_file = (
            here / "logs/20190704_100641/snapshot_model_best_auc_add.npz"
        )  # NOQA
        ...
        if dataset == "my_synthetic":
            root_dir = (
                home
                / "data/datasets/wkentaro/morefusion/ycb_video/synthetic_data/20190507_121544.807309"  # NOQA
            )
            dataset = singleview_3d.datasets.MySyntheticDataset(
                root_dir=root_dir, class_ids=args_data["class_ids"],
            )
        elif dataset == "my_real":
            root_dir = (
                home
                / "data/datasets/wkentaro/morefusion/ycb_video/real_data/20190614_18"  # NOQA
            )
