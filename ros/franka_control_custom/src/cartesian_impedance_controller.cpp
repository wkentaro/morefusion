...
#include <franka_control_custom/cartesian_impedance_controller.h>
#include <franka_control_custom/pseudo_inversion.h>
...
bool CartesianImpedanceController::init(hardware_interface::RobotHW* robot_hw,
  ...
  dynamic_server_compliance_param_ = std::make_unique<
      dynamic_reconfigure::Server<franka_control_custom::compliance_paramConfig>>(
...
void CartesianImpedanceController::complianceParamCallback(
    franka_control_custom::compliance_paramConfig& config,
    uint32_t ) {
...
PLUGINLIB_EXPORT_CLASS(franka_control_custom::CartesianImpedanceController,
