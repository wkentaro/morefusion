...
#include "ros/ros.h"
#include "morefusion_panda/MoveToPose.h"
...
public:
    ...
    bool move_to_pose(morefusion_panda::MoveToPose::Request &service_req,
                               morefusion_panda::MoveToPose::Response &service_res);
};
...
bool PoseService::move_to_pose(morefusion_panda::MoveToPose::Request &service_req,
                                        morefusion_panda::MoveToPose::Response &service_res) {
