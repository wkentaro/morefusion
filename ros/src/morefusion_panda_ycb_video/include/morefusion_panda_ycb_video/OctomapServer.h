...
#include <ros/ros.h>
#include <morefusion_panda_ycb_video/VoxelGridArray.h>
#include <morefusion_panda_ycb_video/ObjectClassArray.h>
#include <morefusion_panda_ycb_video/RenderVoxelGridArray.h>
...
#include "morefusion_panda_ycb_video/OctomapServerConfig.h"
#include "morefusion_panda_ycb_video/utils.h"
...
class OctomapServer {
 public:
  ...
  typedef message_filters::sync_policies::ExactTime<
    ...
    sensor_msgs::Image,
    morefusion_panda_ycb_video::ObjectClassArray> ExactSyncPolicy;
 ...
 protected:
  ...
  void getGridsInWorldFrame(const ros::Time& rostime, morefusion_panda_ycb_video::VoxelGridArray& grids);
  void publishGrids(
  ...
  */
  ...
  void configCallback(
    const morefusion_panda_ycb_video::OctomapServerConfig& config,
  ...
  message_filters::Subscriber<morefusion_panda_ycb_video::ObjectClassArray>* sub_class_;
  message_filters::Synchronizer<ExactSyncPolicy>* sync_;

  dynamic_reconfigure::Server<morefusion_panda_ycb_video::OctomapServerConfig> server_reconfig_;
