...
catkin config --blacklist jsk_network_tools jsk_tools jsk_recognition_msgs imagesift image_view2 jsk_perception jsk_pcl_ros rosbag rosbag_storage franka_control franka_visualization
